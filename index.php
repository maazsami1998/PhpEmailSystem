...
if(isset($_POST["submit"]))
{
	...
	$mail->Password = 'yourpassworkhere';					//Sets SMTP password
	$mail->SMTPSecure = 'ssl';							//Sets connection prefix. Options are "", "ssl" or "tls"
	$mail->From = $_POST["email"];					//Sets the From email address for the message
	$mail->FromName = $_POST["name"];				//Sets the From name of the message
	$mail->AddAddress('xyz@example.com', 'EmailReseciveName');		//Adds a "To" address
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8" style="margin:0 auto; float:none;">
					<h3 align="center">Maaz Email System</h3>
					<br />
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="file" name="resume" accept=".doc,.docx, .pdf,.zip" required />
								</div>
								<div class="form-group">
